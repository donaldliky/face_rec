...
import { wallet } from '../Web3/web3.js';
...
class Activity extends Component {
    ...
    componentDidMount() {
        ...
        this.setState({
            data: JsonData['wallet'],
            walletData: JsonData['wallet']['walletData']
        })
    }
    connectWallet = (idx) => {
        web3 = wallet(idx)
                            ...
                            return (
                                <div key={`wd_${idx}`} className="col-12 col-md-6 col-lg-4 item">
                                    ...
                                    <div className="card single-wallet">
                                        <a className="d-block text-center" onClick={() => this.connectWallet(idx)}>
