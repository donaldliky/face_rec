...
const initData = {
    pre_heading: "YouToken",
    heading: "Create your YouToken - A Token that Represents You",
    content: "Collect your favorite YouTokens and gain value",
    btn_1: "Explore",
    btn_2: "Create"
}
                    ...
                    <div className="row">
                        <div className="col-12 col-md-6 col-lg-7">
                            ...
                            <div className="button-group">
                                ...
                                <Link className="btn btn-bordered-white" to="/face-recognition"><i className="icon-note mr-2" />{this.state.data.btn_2}</Link>
                            </div>
                        </div>
                    </div>
                </div>
