...
class Footer extends Component {
    ...
    componentDidMount() {
        ...
        this.setState({
            data: JsonData['footer'],
            socialData: JsonData['footer']['socialData'],
            widgetData_1: JsonData['footer']['widgetData_1'],
            // widgetData_2: res.data.widgetData_2
        })
    }
    render() {
            ...
            <footer className="footer-area">
                ...
                <div className="footer-top">
                    <div className="container">
                        <div className="row">
                            <div className="col-12 col-sm-6 col-lg-5 res-margin">
                                {/* Footer Items */}
                        ...
                        <div className="row">
                            <div className="col-12">
                                ...
                                <div className="copyright-area d-flex flex-wrap justify-content-center justify-content-sm-between text-center py-4">
                                    {/* Copyright Left */}
                                    <div className="copyright-left">©2021 YouToken, All Rights Reserved.</div>
                                    {/* Copyright Right */}
